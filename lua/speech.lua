...
local anim8 = require(pathToLibs .. 'anim8') -- lib is used for animating trent
local hitButton = 1 -- hit next or before and change speech state  
local r, sc = 0,1.5 -- args for drawing next button

function speech:init()
	background = lg.newImage("assets/bg.jpg");
	trentImg = lg.newImage("assets/robot.png"); 
