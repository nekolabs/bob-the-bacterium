-- coins.lua coins are created and collide with the player (increases score) ... and they're spinning around

local coins = {} -- table holding parts of 1 coin for animation
for i=1,11 do 
	coins[i] = love.graphics.newImage("assets/coinAnimation/coin" .. i .. ".png")
end

-- coin sfx
local coinSound = love.audio.newSource("sfx/coin1.ogg")
coinSound:setLooping(false)

-- starts anim with img1 of 11
local coinHead, coinCountThrough, coinCountOn= coins[1], 1, 0
