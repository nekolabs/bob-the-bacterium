...
-- cost: 2 xp, duration: 15 seconds (timer). Reminder: this item is currently not being used in the game! (oh no!)

-- InvisJection Imgs
local invisJectionImg = love.graphics.newImage("assets/ability/invJection(grey).png")
local invisJeHeight, invisJeWidth = invisJectionImg:getHeight(), invisJectionImg:getWidth()

-- duration timers
invisJStart, invisJMax, invisJVel = 0,15,1   
