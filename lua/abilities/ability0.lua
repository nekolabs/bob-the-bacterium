...
-- InvJection Imgs
local invJectionImg = love.graphics.newImage("assets/ability/invJection(blue).png")
local invJeHeight, invJeWidth = invJectionImg:getHeight(), invJectionImg:getWidth()
local starImg = love.graphics.newImage("assets/ability/invincState.png")

-- duration timers (global variables, because used in playerCollide file 
invJStart, invJMax, invJVel = 0,15,1
